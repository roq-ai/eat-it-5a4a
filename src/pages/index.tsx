  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Eat IT - Crafting your perfect meal, making online orders and reservations simple. Experience the ease of personalizing your dish and the joy of seamless dining."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Eat IT - Crafting your perfect meal, making online orders and reservations simple. Experience the ease of personalizing your dish and the joy of seamless dining.`}
            </Text>
            <Box
