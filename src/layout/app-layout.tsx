...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['restaurant-owner', 'restaurant-manager', 'system-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Meals', path: '/meals', entity: 'meal', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
