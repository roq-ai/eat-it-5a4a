...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'restaurant.update': { roles: ['owner', 'manager'], key: 'restaurant-details-updated', tenantPath: [], userPath: [] },
  'meal.update': {
    roles: ['owner', 'manager'],
    key: 'meal-configuration-changed',
    tenantPath: ['restaurant', 'meal'],
    userPath: [],
  },
  'user.update': { roles: ['manager'], key: 'manager-role-changed', tenantPath: ['restaurant', 'user'], userPath: [] },
  'order.update': {
    roles: ['owner', 'manager'],
    key: 'order-status-updated',
    tenantPath: ['restaurant', 'meal', 'order'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['restaurant-owner', 'restaurant-manager', 'system-administrator'];
